...
export const MsgNewWorkspace: MessageFns<MsgNewWorkspace> = {
  ...
  fromJSON(object: any): MsgNewWorkspace {
    return {
      ...
      adminPolicyId: isSet(object.adminPolicyId)
        ? globalThis.Number(object.adminPolicyId)
        : 0,
      signPolicyId: isSet(object.signPolicyId)
        ? globalThis.Number(object.signPolicyId)
        : 0,
  ...
  create<I extends Exact<DeepPartial<MsgNewWorkspace>, I>>(
    base?: I
  ): MsgNewWorkspace {
    return MsgNewWorkspace.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgNewWorkspace>, I>>(
    object: I
  ): MsgNewWorkspace {
    const message = createBaseMsgNewWorkspace();
...
export const MsgNewWorkspaceResponse: MessageFns<MsgNewWorkspaceResponse> = {
  encode(
    message: MsgNewWorkspaceResponse,
    writer: BinaryWriter = new BinaryWriter()
  ): BinaryWriter {
    if (message.addr !== '') {
  ...
  create<I extends Exact<DeepPartial<MsgNewWorkspaceResponse>, I>>(
    base?: I
  ): MsgNewWorkspaceResponse {
    return MsgNewWorkspaceResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgNewWorkspaceResponse>, I>>(
    object: I
  ): MsgNewWorkspaceResponse {
    const message = createBaseMsgNewWorkspaceResponse();
...
export const MsgAddWorkspaceOwner: MessageFns<MsgAddWorkspaceOwner> = {
  ...
  fromJSON(object: any): MsgAddWorkspaceOwner {
    return {
      creator: isSet(object.creator) ? globalThis.String(object.creator) : '',
      workspaceAddr: isSet(object.workspaceAddr)
        ? globalThis.String(object.workspaceAddr)
        : '',
  ...
  create<I extends Exact<DeepPartial<MsgAddWorkspaceOwner>, I>>(
    base?: I
  ): MsgAddWorkspaceOwner {
    return MsgAddWorkspaceOwner.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAddWorkspaceOwner>, I>>(
    object: I
  ): MsgAddWorkspaceOwner {
    const message = createBaseMsgAddWorkspaceOwner();
    message.creator = object.creator ?? '';
...
export const MsgAddWorkspaceOwnerResponse: MessageFns<MsgAddWorkspaceOwnerResponse> =
  {
    encode(
      _: MsgAddWorkspaceOwnerResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    create<I extends Exact<DeepPartial<MsgAddWorkspaceOwnerResponse>, I>>(
      base?: I
    ): MsgAddWorkspaceOwnerResponse {
      return MsgAddWorkspaceOwnerResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgAddWorkspaceOwnerResponse>, I>>(
      _: I
    ): MsgAddWorkspaceOwnerResponse {
      const message = createBaseMsgAddWorkspaceOwnerResponse();
      return message;
...
export const MsgAppendChildWorkspace: MessageFns<MsgAppendChildWorkspace> = {
  ...
  fromJSON(object: any): MsgAppendChildWorkspace {
    return {
      creator: isSet(object.creator) ? globalThis.String(object.creator) : '',
      parentWorkspaceAddr: isSet(object.parentWorkspaceAddr)
        ? globalThis.String(object.parentWorkspaceAddr)
        : '',
      childWorkspaceAddr: isSet(object.childWorkspaceAddr)
        ? globalThis.String(object.childWorkspaceAddr)
        : '',
      btl: isSet(object.btl) ? globalThis.Number(object.btl) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<MsgAppendChildWorkspace>, I>>(
    base?: I
  ): MsgAppendChildWorkspace {
    return MsgAppendChildWorkspace.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAppendChildWorkspace>, I>>(
    object: I
  ): MsgAppendChildWorkspace {
    const message = createBaseMsgAppendChildWorkspace();
    message.creator = object.creator ?? '';
...
export const MsgAppendChildWorkspaceResponse: MessageFns<MsgAppendChildWorkspaceResponse> =
  {
    encode(
      _: MsgAppendChildWorkspaceResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    decode(
      input: BinaryReader | Uint8Array,
      length?: number
    ): MsgAppendChildWorkspaceResponse {
      const reader =
        input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
    ...
    create<I extends Exact<DeepPartial<MsgAppendChildWorkspaceResponse>, I>>(
      base?: I
    ): MsgAppendChildWorkspaceResponse {
      return MsgAppendChildWorkspaceResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<
      I extends Exact<DeepPartial<MsgAppendChildWorkspaceResponse>, I>,
    >(_: I): MsgAppendChildWorkspaceResponse {
      const message = createBaseMsgAppendChildWorkspaceResponse();
      return message;
    },
  };
...
export const MsgNewChildWorkspace: MessageFns<MsgNewChildWorkspace> = {
  ...
  create<I extends Exact<DeepPartial<MsgNewChildWorkspace>, I>>(
    base?: I
  ): MsgNewChildWorkspace {
    return MsgNewChildWorkspace.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgNewChildWorkspace>, I>>(
    object: I
  ): MsgNewChildWorkspace {
    const message = createBaseMsgNewChildWorkspace();
    message.creator = object.creator ?? '';
...
export const MsgNewChildWorkspaceResponse: MessageFns<MsgNewChildWorkspaceResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<MsgNewChildWorkspaceResponse>, I>>(
      base?: I
    ): MsgNewChildWorkspaceResponse {
      return MsgNewChildWorkspaceResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgNewChildWorkspaceResponse>, I>>(
      object: I
    ): MsgNewChildWorkspaceResponse {
      const message = createBaseMsgNewChildWorkspaceResponse();
...
export const MsgRemoveWorkspaceOwner: MessageFns<MsgRemoveWorkspaceOwner> = {
  ...
  create<I extends Exact<DeepPartial<MsgRemoveWorkspaceOwner>, I>>(
    base?: I
  ): MsgRemoveWorkspaceOwner {
    return MsgRemoveWorkspaceOwner.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRemoveWorkspaceOwner>, I>>(
    object: I
  ): MsgRemoveWorkspaceOwner {
    const message = createBaseMsgRemoveWorkspaceOwner();
    message.creator = object.creator ?? '';
...
export const MsgRemoveWorkspaceOwnerResponse: MessageFns<MsgRemoveWorkspaceOwnerResponse> =
  {
    encode(
      _: MsgRemoveWorkspaceOwnerResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    create<I extends Exact<DeepPartial<MsgRemoveWorkspaceOwnerResponse>, I>>(
      base?: I
    ): MsgRemoveWorkspaceOwnerResponse {
      return MsgRemoveWorkspaceOwnerResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<
      I extends Exact<DeepPartial<MsgRemoveWorkspaceOwnerResponse>, I>,
    >(_: I): MsgRemoveWorkspaceOwnerResponse {
      const message = createBaseMsgRemoveWorkspaceOwnerResponse();
      return message;
    },
  };
...
export const MsgNewKeyring: MessageFns<MsgNewKeyring> = {
  ...
  fromJSON(object: any): MsgNewKeyring {
    return {
      ...
      description: isSet(object.description)
        ...
        : '',
      partyThreshold: isSet(object.partyThreshold)
        ? globalThis.Number(object.partyThreshold)
        : 0,
      keyReqFee: isSet(object.keyReqFee)
        ? globalThis.Number(object.keyReqFee)
        : 0,
      sigReqFee: isSet(object.sigReqFee)
        ? globalThis.Number(object.sigReqFee)
        : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<MsgNewKeyring>, I>>(
    base?: I
  ): MsgNewKeyring {
    return MsgNewKeyring.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgNewKeyring>, I>>(
    object: I
  ): MsgNewKeyring {
    const message = createBaseMsgNewKeyring();
    message.creator = object.creator ?? '';
...
export const MsgNewKeyringResponse: MessageFns<MsgNewKeyringResponse> = {
  ...
  create<I extends Exact<DeepPartial<MsgNewKeyringResponse>, I>>(
    base?: I
  ): MsgNewKeyringResponse {
    return MsgNewKeyringResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgNewKeyringResponse>, I>>(
    object: I
  ): MsgNewKeyringResponse {
    const message = createBaseMsgNewKeyringResponse();
    message.addr = object.addr ?? '';
...
export const MsgAddKeyringParty: MessageFns<MsgAddKeyringParty> = {
  ...
  fromJSON(object: any): MsgAddKeyringParty {
    return {
      creator: isSet(object.creator) ? globalThis.String(object.creator) : '',
      keyringAddr: isSet(object.keyringAddr)
        ? globalThis.String(object.keyringAddr)
        : '',
      party: isSet(object.party) ? globalThis.String(object.party) : '',
      increaseThreshold: isSet(object.increaseThreshold)
        ? globalThis.Boolean(object.increaseThreshold)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<MsgAddKeyringParty>, I>>(
    base?: I
  ): MsgAddKeyringParty {
    return MsgAddKeyringParty.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAddKeyringParty>, I>>(
    object: I
  ): MsgAddKeyringParty {
    const message = createBaseMsgAddKeyringParty();
    message.creator = object.creator ?? '';
...
export const MsgAddKeyringPartyResponse: MessageFns<MsgAddKeyringPartyResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<MsgAddKeyringPartyResponse>, I>>(
      base?: I
    ): MsgAddKeyringPartyResponse {
      return MsgAddKeyringPartyResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgAddKeyringPartyResponse>, I>>(
      _: I
    ): MsgAddKeyringPartyResponse {
      const message = createBaseMsgAddKeyringPartyResponse();
      return message;
...
export const MsgUpdateKeyring: MessageFns<MsgUpdateKeyring> = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateKeyring>, I>>(
    base?: I
  ): MsgUpdateKeyring {
    return MsgUpdateKeyring.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateKeyring>, I>>(
    object: I
  ): MsgUpdateKeyring {
    const message = createBaseMsgUpdateKeyring();
    message.creator = object.creator ?? '';
...
export const MsgUpdateKeyringResponse: MessageFns<MsgUpdateKeyringResponse> = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateKeyringResponse>, I>>(
    base?: I
  ): MsgUpdateKeyringResponse {
    return MsgUpdateKeyringResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateKeyringResponse>, I>>(
    _: I
  ): MsgUpdateKeyringResponse {
    const message = createBaseMsgUpdateKeyringResponse();
    return message;
...
export const MsgRemoveKeyringParty: MessageFns<MsgRemoveKeyringParty> = {
  ...
  fromJSON(object: any): MsgRemoveKeyringParty {
    return {
      ...
      keyringAddr: isSet(object.keyringAddr)
        ...
        : '',
      party: isSet(object.party) ? globalThis.String(object.party) : '',
      decreaseThreshold: isSet(object.decreaseThreshold)
        ? globalThis.Boolean(object.decreaseThreshold)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<MsgRemoveKeyringParty>, I>>(
    base?: I
  ): MsgRemoveKeyringParty {
    return MsgRemoveKeyringParty.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRemoveKeyringParty>, I>>(
    object: I
  ): MsgRemoveKeyringParty {
    const message = createBaseMsgRemoveKeyringParty();
    message.creator = object.creator ?? '';
...
export const MsgRemoveKeyringPartyResponse: MessageFns<MsgRemoveKeyringPartyResponse> =
  {
    encode(
      _: MsgRemoveKeyringPartyResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    create<I extends Exact<DeepPartial<MsgRemoveKeyringPartyResponse>, I>>(
      base?: I
    ): MsgRemoveKeyringPartyResponse {
      return MsgRemoveKeyringPartyResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgRemoveKeyringPartyResponse>, I>>(
      _: I
    ): MsgRemoveKeyringPartyResponse {
      const message = createBaseMsgRemoveKeyringPartyResponse();
      return message;
...
export const MsgAddKeyringAdmin: MessageFns<MsgAddKeyringAdmin> = {
  ...
  create<I extends Exact<DeepPartial<MsgAddKeyringAdmin>, I>>(
    base?: I
  ): MsgAddKeyringAdmin {
    return MsgAddKeyringAdmin.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAddKeyringAdmin>, I>>(
    object: I
  ): MsgAddKeyringAdmin {
    const message = createBaseMsgAddKeyringAdmin();
    message.creator = object.creator ?? '';
...
export const MsgAddKeyringAdminResponse: MessageFns<MsgAddKeyringAdminResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<MsgAddKeyringAdminResponse>, I>>(
      base?: I
    ): MsgAddKeyringAdminResponse {
      return MsgAddKeyringAdminResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgAddKeyringAdminResponse>, I>>(
      _: I
    ): MsgAddKeyringAdminResponse {
      const message = createBaseMsgAddKeyringAdminResponse();
      return message;
...
export const MsgRemoveKeyringAdmin: MessageFns<MsgRemoveKeyringAdmin> = {
  ...
  create<I extends Exact<DeepPartial<MsgRemoveKeyringAdmin>, I>>(
    base?: I
  ): MsgRemoveKeyringAdmin {
    return MsgRemoveKeyringAdmin.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgRemoveKeyringAdmin>, I>>(
    object: I
  ): MsgRemoveKeyringAdmin {
    const message = createBaseMsgRemoveKeyringAdmin();
    message.creator = object.creator ?? '';
...
export const MsgRemoveKeyringAdminResponse: MessageFns<MsgRemoveKeyringAdminResponse> =
  {
    encode(
      _: MsgRemoveKeyringAdminResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    create<I extends Exact<DeepPartial<MsgRemoveKeyringAdminResponse>, I>>(
      base?: I
    ): MsgRemoveKeyringAdminResponse {
      return MsgRemoveKeyringAdminResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgRemoveKeyringAdminResponse>, I>>(
      _: I
    ): MsgRemoveKeyringAdminResponse {
      const message = createBaseMsgRemoveKeyringAdminResponse();
      return message;
...
export const MsgUpdateWorkspace: MessageFns<MsgUpdateWorkspace> = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateWorkspace>, I>>(
    base?: I
  ): MsgUpdateWorkspace {
    return MsgUpdateWorkspace.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateWorkspace>, I>>(
    object: I
  ): MsgUpdateWorkspace {
    const message = createBaseMsgUpdateWorkspace();
    message.creator = object.creator ?? '';
...
export const MsgUpdateWorkspaceResponse: MessageFns<MsgUpdateWorkspaceResponse> =
  {
    ...
    create<I extends Exact<DeepPartial<MsgUpdateWorkspaceResponse>, I>>(
      base?: I
    ): MsgUpdateWorkspaceResponse {
      return MsgUpdateWorkspaceResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgUpdateWorkspaceResponse>, I>>(
      _: I
    ): MsgUpdateWorkspaceResponse {
      const message = createBaseMsgUpdateWorkspaceResponse();
      return message;
...
export const MsgDeactivateKeyring: MessageFns<MsgDeactivateKeyring> = {
  ...
  create<I extends Exact<DeepPartial<MsgDeactivateKeyring>, I>>(
    base?: I
  ): MsgDeactivateKeyring {
    return MsgDeactivateKeyring.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgDeactivateKeyring>, I>>(
    object: I
  ): MsgDeactivateKeyring {
    const message = createBaseMsgDeactivateKeyring();
    message.creator = object.creator ?? '';
...
export const MsgDeactivateKeyringResponse: MessageFns<MsgDeactivateKeyringResponse> =
  {
    encode(
      _: MsgDeactivateKeyringResponse,
      writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
      return writer;
    },
    ...
    create<I extends Exact<DeepPartial<MsgDeactivateKeyringResponse>, I>>(
      base?: I
    ): MsgDeactivateKeyringResponse {
      return MsgDeactivateKeyringResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<MsgDeactivateKeyringResponse>, I>>(
      _: I
    ): MsgDeactivateKeyringResponse {
      const message = createBaseMsgDeactivateKeyringResponse();
      return message;
...
export interface Msg {
  ...
  AddWorkspaceOwner(
    request: MsgAddWorkspaceOwner
  ): Promise<MsgAddWorkspaceOwnerResponse>;
  /** AppendChildWorkspace defines an operation for appending a child workspace */
  AppendChildWorkspace(
    request: MsgAppendChildWorkspace
  ): Promise<MsgAppendChildWorkspaceResponse>;
  /** NewChildWorkspace defines an operation for creating a new child workspace */
  NewChildWorkspace(
    request: MsgNewChildWorkspace
  ): Promise<MsgNewChildWorkspaceResponse>;
  /** RemoveWorkspaceOwner defines an operation for removing a workspace owner */
  RemoveWorkspaceOwner(
    request: MsgRemoveWorkspaceOwner
  ): Promise<MsgRemoveWorkspaceOwnerResponse>;
  ...
  AddKeyringParty(
    request: MsgAddKeyringParty
  ): Promise<MsgAddKeyringPartyResponse>;
  ...
  RemoveKeyringParty(
    request: MsgRemoveKeyringParty
  ): Promise<MsgRemoveKeyringPartyResponse>;
  /** AddKeyringAdmin defines an operation to add an admin to a keyring */
  AddKeyringAdmin(
    request: MsgAddKeyringAdmin
  ): Promise<MsgAddKeyringAdminResponse>;
  /** RemoveKeyringAdmin defines an operation to remove an admin from a keyring */
  RemoveKeyringAdmin(
    request: MsgRemoveKeyringAdmin
  ): Promise<MsgRemoveKeyringAdminResponse>;
  /** Update a workspace, e.g. changing the policies in use. */
  UpdateWorkspace(
    request: MsgUpdateWorkspace
  ): Promise<MsgUpdateWorkspaceResponse>;
  /** Deactivate a keyring */
  DeactivateKeyring(
    request: MsgDeactivateKeyring
  ): Promise<MsgDeactivateKeyringResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  NewWorkspace(request: MsgNewWorkspace): Promise<MsgNewWorkspaceResponse> {
    ...
    return promise.then((data) =>
      MsgNewWorkspaceResponse.decode(new BinaryReader(data))
    );
  }
  ...
  AddWorkspaceOwner(
    ...
    return promise.then((data) =>
      MsgAddWorkspaceOwnerResponse.decode(new BinaryReader(data))
    );
  }
  ...
  AppendChildWorkspace(
    ...
    return promise.then((data) =>
      MsgAppendChildWorkspaceResponse.decode(new BinaryReader(data))
    );
  }
  ...
  NewChildWorkspace(
    ...
    return promise.then((data) =>
      MsgNewChildWorkspaceResponse.decode(new BinaryReader(data))
    );
  }
  ...
  RemoveWorkspaceOwner(
    ...
    return promise.then((data) =>
      MsgRemoveWorkspaceOwnerResponse.decode(new BinaryReader(data))
    );
  }
  ...
  NewKeyring(request: MsgNewKeyring): Promise<MsgNewKeyringResponse> {
    ...
    return promise.then((data) =>
      MsgNewKeyringResponse.decode(new BinaryReader(data))
    );
  }
  ...
  AddKeyringParty(
    ...
    return promise.then((data) =>
      MsgAddKeyringPartyResponse.decode(new BinaryReader(data))
    );
  }
  ...
  UpdateKeyring(request: MsgUpdateKeyring): Promise<MsgUpdateKeyringResponse> {
    ...
    return promise.then((data) =>
      MsgUpdateKeyringResponse.decode(new BinaryReader(data))
    );
  }
  ...
  RemoveKeyringParty(
    ...
    return promise.then((data) =>
      MsgRemoveKeyringPartyResponse.decode(new BinaryReader(data))
    );
  }
  ...
  AddKeyringAdmin(
    ...
    return promise.then((data) =>
      MsgAddKeyringAdminResponse.decode(new BinaryReader(data))
    );
  }
  ...
  RemoveKeyringAdmin(
    ...
    return promise.then((data) =>
      MsgRemoveKeyringAdminResponse.decode(new BinaryReader(data))
    );
  }
  ...
  UpdateWorkspace(
    ...
    return promise.then((data) =>
      MsgUpdateWorkspaceResponse.decode(new BinaryReader(data))
    );
  }
  ...
  DeactivateKeyring(
    ...
    return promise.then((data) =>
      MsgDeactivateKeyringResponse.decode(new BinaryReader(data))
    );
  }
}
